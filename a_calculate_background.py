...
def calculate_background(filename,
    ...
    try:
        ...
        seriesCount, sizeT, sizeC, sizeX, sizeY, sizeZ = cziutils.summarize_image_size(
            reader)
        ...
        res = bview.map_async(
            lambda row: summarize_image(row, _reader, thumbnail_size, quantile
                                        ),
        ...
        sleep(2)
        res = bview.map_async(
            lambda row: threshold_image(row, _reader, sigma, th_low, th_high),
